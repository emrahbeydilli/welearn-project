...
<body>
  ...
  <div class="container" id="content">
      <h1 class="text-center border-bottom py-3 mb-4">Resources</h1>
      <!-- Collapsible Accordion -->
      <div class="accordion pb-3" id="rAccordion">
        <!-- From Teaching to Learning Experience -->
        <div class="card">
          <div class="card-header" id="r1">
            <h2 class="mb-0">
              <button class="btn btn-link text-left" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                WeLearn Webinar Presentation Slides
              </button>
            </h2>
          </div>
          <div id="collapseOne" class="collapse show" aria-labelledby="r1" data-parent="#rAccordion">
            <div class="card-body">
              <p>Download Documents </p>
              <ul class="list-group  list-group-horizontal">
                <li class="list-group-item"><a href="files/Webinar_Presentation_July_2nd_2020.pptx" target="_blank">Presentation</a></li>
                <li class="list-group-item"><a href="files/Webinar_Presentation_July_2nd_2020.pdf" target="_blank">PDF File</a></li>
              </ul>
            </div>
          </div>
        </div>
